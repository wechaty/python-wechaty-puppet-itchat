...
from wechaty import Contact, Room, Wechaty, get_logger, Message ,FileBox,UrlLink,RoomQueryFilter,ContactQueryFilter,RoomMemberQueryFilter,WechatyOptions
from wechaty_plugin_contrib import DingDongPlugin,AutoReplyPlugin
...
if __name__ == '__main__':
    ...
    uvicorn.run(app="hotreload_bot:app", host="127.0.0.1", port=19002, reload=True,log_level="info")